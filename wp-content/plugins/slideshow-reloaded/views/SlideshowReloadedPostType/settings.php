<?php if ($data instanceof stdClass) : ?>
	...
	continue;
		...
		<tr>
			<td colspan="3" style="border-bottom: 1px solid #e5e5e5; text-align: center;">
				<span style="display: inline-block; position: relative; top: 14px; padding: 0 12px; background: #fff;">
					<?php echo $value['group'] ?> <?php _e('settings', 'slideshow-reloaded') ?>
				</span>
			</td>
		</tr>
		<tr>
		...
		>
			...
			<td><?php echo SlideshowReloadedSlideshowSettingsHandler::getInputField(SlideshowReloadedSlideshowSettingsHandler::$settingsKey, esc_html($key), $value) ?></td>
